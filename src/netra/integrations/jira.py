...
class JiraClient:
    ...
    def __init__(
        ...
        if base_url:
            ...
            # Block private/internal IPs to prevent SSRF. Atlassian Cloud hosts are
            # accepted without DNS resolution so tests and offline setups stay stable.
    ...
    def _build_description(self, finding: dict[str, Any], scan: dict[str, Any]) -> str:
        ...
        lines = [
            ...
            "",
            f"*Title:* {finding.get('title', 'Unknown Finding')}",
